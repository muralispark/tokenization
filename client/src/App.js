...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1>JPMC Starbucks Cappucino Token</h1>
        <h2>Merry Cryptocurrency Account Statement!</h2>
        <p>Get your Tokens today!</p>
        <h2>KYC Account Allowlisting</h2>
        Address to allow: <input type="text" name="kycAddress" value={this.state.kycAddress} onChange={this.handleInputChange} />
        <button type="button" onClick={this.handleKycWhitelisting}>Add to Allowlist</button>
        <h2>Buy Tokens</h2>
